        ...
        ?>
            ...
            <div class="part-2">
                ...
                <?php if(!isset($_SESSION['user_name'])){?>
                    <a class="link" href="./auth/login.php"><button type="button" class="btn btn-dark">Buy Prompt</button></a>
                <?php } else { ?>
                    <a class="link" href="./checkout.php"><button type="button" class="btn btn-dark">Buy Prompt</button></a>
                <?php } ?>
            </div>
        <?php endwhile; ?>
    </div>
