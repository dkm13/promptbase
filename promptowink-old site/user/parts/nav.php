...
<body>
 ...
 <nav class="navbar navbar-expand-md navbar-dark bg-dark" aria-label="Fourth navbar example">
    <div class="container-fluid">
      <a class="navbar-brand" href="user_dashboard.php"><img src="../uploads/logo.png" alt="logo"/></a>
      <li class="nav-item">
      ...
      <div class="collapse navbar-collapse " id="navbarsExample04">
        <ul class="navbar-nav me-auto mb-2 mb-md-0 mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./admin_prompts.php">
              Prompts
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./admin_new.php">New Prompt</a>
          </li>
          </ul>
